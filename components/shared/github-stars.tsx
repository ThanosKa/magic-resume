...
const API_URL = 'https://api.github.com/repos/ThanosKa/magic-resume';
const REPO_URL = 'https://github.com/ThanosKa/magic-resume';
...
export function GitHubStars() {
  ...
  return (
    <motion.a
      ...
      aria-label="Star Magic Resume on GitHub"
    >
      <div
        aria-hidden
        className={cn(
